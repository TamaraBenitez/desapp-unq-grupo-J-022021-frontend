...
const CardActivities = ({activityId,hour,userId,criptoName,valueCripto,nominals,ars,username,lastName,operations,reputation}) => {
            ...
            <ListItem sx={{ backgroundColor: "black", border: "1px solid grey" }}>
                ...
                >
                    <Typography
                        ...
                        component="div"
                    >
                        <img src={asoc[criptoName]} alt="iconCrypt" width="20" height="20" style={{ paddingRight: "10px" }} />
                        {criptoName}
                    </Typography>
                    ...
                    <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                        ...
                        <Grid item xs={6}>
                            <Item>{t("user")} : {username} {lastName}</Item>
                        </Grid>

                        <Grid item xs={6}>
                            <Item>{t("operations")} : {operations === 0?t("operationsNull"):operations}</Item>
                        </Grid>

                        <Grid item xs={6}>
                            <Item>{t("reputation")} : {reputation}</Item>
                        </Grid>
